...
INPUT_STATIC_PARAMS_FILE  = WD + 'static_calib_params_1-month_v3.3.4.npz'
OUTPUT_RISK         = WD + 'DGP_1-month_risk_v3.3.5.csv'
SCENARIO_OUT        = WD + 'DGP_IR_scenarios_1-month_v3.3.5.csv'
DYNAMIC_PARAMS_OUT  = WD + 'dgp_dynamic_params_1-month_v3.3.5.npz'
OUT_STATIC_PARAMS_FILE  = WD + 'static_calib_params_1-month_v3.3.5.npz'


# Inducing point counts
NUM_INDUCING_STATIC  = 500
NUM_INDUCING_DYNAMIC = 100
...
ONLINE_UPDATE_STEPS = 80   # Adam steps per window
