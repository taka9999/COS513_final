...
INPUT_STATIC_PARAMS_FILE  = WD + 'static_calib_params_1-month_v3.3.4.npz' #'static_calib_params_1-year_v3.3.2.npz'
OUTPUT_RISK         = WD + 'DGP_1-year_risk_v3.3.3.csv'
SCENARIO_OUT        = WD + 'DGP_IR_scenarios_1-year_v3.3.3.csv'
DYNAMIC_PARAMS_OUT  = WD + 'dgp_dynamic_params_1-year_v3.3.3.npz'
OUT_STATIC_PARAMS_FILE  = WD + 'static_calib_params_1-year_v3.3.3.npz'
